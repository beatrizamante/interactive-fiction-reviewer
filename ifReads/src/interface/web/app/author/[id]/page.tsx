  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-125 h-75 bg-primary/5 blur-[120px] rounded-full" />
        <div className="absolute bottom-1/4 left-0 w-100 h-100 bg-accent/5 blur-[100px] rounded-full" />
      </div>
      ...
      <main className="relative z-10 px-6 md:px-12 lg:px-20 py-8">
              ...
              {author.twitter && (
                ...
                >
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <Twitter className="w-4 h-4 mr-2" />@{author.twitter}
                  </a>
                </Button>
              )}
              <Button
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-sm text-muted-foreground">
              ...
              {author.stories.length === 1 ? 'story' : 'stories'}
            </span>
          </div>
        ...
        <section className="mt-16 p-8 rounded-2xl bg-card/50 border border-border/50">
          ...
          <p className="text-muted-foreground mb-6">
            Visit the {"author's"} official website or external platforms to
      ...
      stories: [
        {
          ...
          reviewCount: 324,
          description:
            'A storm-battered coast holds secrets from a century past. Your choices will illuminate the truth.',
          wordCount: 45000,
          playTime: '3-4 hours',
        ...
        },
        {
          ...
          reviewCount: 256,
          description:
            'A Victorian medium. A skeptical journalist. A séance that goes terribly wrong.',
          wordCount: 38000,
          playTime: '2-3 hours',
        ...
        },
        {
          ...
          reviewCount: 198,
          description:
            'Returning to your hometown after 20 years, you find that some memories were better left buried.',
          wordCount: 52000,
          playTime: '4-5 hours',
        ...
        },
        {
          ...
          reviewCount: 114,
          description:
            "Your father left behind a map to a place that shouldn't exist. Now you must decide whether to follow it.",
          wordCount: 61000,
          playTime: '5-6 hours',
      ...
      stories: [
        {
          ...
          reviewCount: 512,
          description:
            'Captain your own vessel through uncharted galaxies where every decision echoes across the cosmos.',
          wordCount: 120000,
          playTime: '8-12 hours',
        ...
        },
        {
          ...
          reviewCount: 389,
          description:
            "You're humanity's first ambassador to an alien species. Don't mess this up.",
          wordCount: 75000,
          playTime: '6-8 hours',
        ...
        },
        {
          ...
          reviewCount: 346,
          description:
            'Generation ship survival. Resources are limited. Moral choices are not.',
          wordCount: 89000,
          playTime: '7-9 hours',
      ...
      stories: [
        {
          ...
          reviewCount: 678,
          description:
            'An enchanted garden where flowers speak and paths shift. Find the heart of the maze before dawn.',
          wordCount: 32000,
          playTime: '2-3 hours',
        ...
        },
        {
          ...
          reviewCount: 534,
          description:
            "You collect other people's forgotten memories. But whose memories are your own?",
          wordCount: 28000,
          playTime: '2-3 hours',
        ...
        },
        {
          ...
          reviewCount: 412,
          description:
            'A festival night where the veil between worlds grows thin. Light a lantern. Make a wish.',
          wordCount: 24000,
          playTime: '1-2 hours',
